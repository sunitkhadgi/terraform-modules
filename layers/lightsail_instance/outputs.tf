...
#   value       = module.aws_lightsail_instance.lightsail_instance.id
# }

# output "lightsail_instance_public_ip" {
#   description = "Public IP address of the Lightsail instance"
#   value       = module.aws_lightsail_instance.lightsail_instance.public_ip_address
# }

# output "static_ip_id" {
#   description = "ID of the Lightsail static IP"
#   value       = module.aws_lightsail_static_ip.static_ip[*].id
# }

# output "static_ip_address" {
#   description = "Public IP address of the Lightsail static IP"
#   value       = module.aws_lightsail_static_ip.static_ip[*].ip_address
# }
